...
- Use helmet with permissive CSP: allow 5 oEmbed provider domains (Spotify, Apple Music, YouTube, SoundCloud, Bandcamp) in frame-src; Gravatar covered by imgSrc (used as `<img>` tags, not iframes)
